...
class getCategoryTypeService extends AdminKernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['PrestaShopBundle\\Form\\Admin\\Catalog\\Category\\CategoryType'])) {
            return $container->privates['PrestaShopBundle\\Form\\Admin\\Catalog\\Category\\CategoryType'];
        }
