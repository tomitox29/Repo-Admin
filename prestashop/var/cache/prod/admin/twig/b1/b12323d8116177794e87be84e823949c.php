...
class __TwigTemplate_8a938487435fcd4d07a84fc693194db6 extends Template
{
    private $source;
    private $macros = [];
  ...
  <div class=\"row\">
    ...
    ";
        // line 56
        if (((($context["level"] ?? null) > twig_constant("PrestaShop\\PrestaShop\\Core\\Security\\Permission::LEVEL_UPDATE")) && array_key_exists("bulkActions", $context))) {
            // line 57
