...
class __TwigTemplate_f8aa2959733c37a82e04f40858210b96 extends Template
{
    private $source;
    private $macros = [];
  ...
  <script>
    ...
    var moduleTranslations = {
      'singleModuleModalUpdateTitle': '";
        // line 38
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Are you sure you want to update this module?", [], "Admin.Modules.Notification"), "html", null, true);
        echo "',
      'multipleModuleModalUpdateTitle': '";
        // line 39
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Are you sure you want to update these modules?", [], "Admin.Modules.Notification"), "html", null, true);
        echo "',
      ...
      'upgradeAnywayButtonText': '";
        // line 43
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Update anyway", [], "Admin.Actions"), "html", null, true);
        echo "',
      'moduleModalUpdateConfirmMessage': '";
        // line 44
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("We strongly advise you to update the modules on maintenance mode to avoid any cache issues.", [], "Admin.Modules.Notification"), "html", null, true);
        echo "',
    };
