...
class __TwigTemplate_54deddfdefe936641b4b5e3c8c1aba56 extends Template
{
    private $source;
    private $macros = [];
  ...
  <td colspan=\"";
    ...
    ";
        ...
        if (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["grid"] ?? null), "attributes", [], "any", false, false, false, 28), "is_empty_state", [], "any", false, false, false, 28)) {
            // line 29
            echo "      ";
            $this->loadTemplate([(("@PrestaShop/Admin/Common/Grid/Blocks/EmptyState/" . twig_get_attribute($this->env, $this->source,             // line 30
($context["grid"] ?? null), "id", [], "any", false, false, false, 30)) . ".html.twig"), "@PrestaShop/Admin/Common/Grid/Blocks/EmptyState/_default.html.twig"], "@PrestaShop/Admin/Common/Grid/Blocks/Table/empty_row.html.twig", 29)->display(twig_array_merge($context, ["grid" =>             // line 32
($context["grid"] ?? null)]));
            // line 34
            echo "    ";
        } else {
