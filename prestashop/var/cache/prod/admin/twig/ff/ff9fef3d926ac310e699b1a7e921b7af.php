...
class __TwigTemplate_6f677f0d23b71b3120d442c23de97dc1 extends Template
{
    private $source;
    private $macros = [];
  ...
  ";
            ...
            if ((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["form"] ?? null), "vars", [], "any", false, true, false, 139), "valid", [], "any", true, true, false, 139) &&  !twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["form"] ?? null), "vars", [], "any", false, false, false, 139), "valid", [], "any", false, false, false, 139))) {
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["parentError"]) {
                    // line 141
                    echo "      ";
                    $context["errors"] = twig_array_merge(($context["errors"] ?? null), [twig_get_attribute($this->env, $this->source, $context["parentError"], "message", [], "any", false, false, false, 141)]);
                    // line 142
                    echo "    ";
                }
  ...
  ";
    ...
    ";
      ...
      ";
          ...
          ";
                        ...
                        foreach ($context['_seq'] as $context["_key"] => $context["translatableError"]) {
                            // line 162
                            echo "            ";
                            $context["translatableErrors"] = twig_array_merge(($context["translatableErrors"] ?? null), [twig_get_attribute($this->env, $this->source, $context["translatableError"], "error_message", [], "any", false, false, false, 162)]);
                            // line 163
                            echo "          ";
                        }
                        $_parent = $context['_parent'];
          ...
          ";
                        ...
                        foreach ($context['_seq'] as $context["_key"] => $context["error"]) {
                            ...
                            if (!twig_in_filter($context["error"], ($context["translatableErrors"] ?? null))) {
                                // line 168
                                echo "              ";
                                $context["popoverErrors"] = twig_array_merge(($context["popoverErrors"] ?? null), [$context["error"]]);
                                // line 169
                                echo "            ";
                            }
                            // line 170
      ...
      ";
        ...
        ";
                        // line 184
                        $context["errorMessages"] = twig_array_merge(($context["errorMessages"] ?? null), [($context["errorMessage"] ?? null)]);
                        // line 185
                        echo "      ";
                    }
                    $_parent = $context['_parent'];
...
";
  ...
  ";
    ...
    ";
                // line 347
                if (is_iterable(twig_get_attribute($this->env, $this->source, ($context["extraVars"] ?? null), "languages", [], "any", false, false, false, 347))) {
                    // line 348
                    echo "      ";
                    $context['_parent'] = $context;
