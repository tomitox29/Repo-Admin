...
class __TwigTemplate_e4d86fcede668521791509a246c4f5e7 extends Template
{
    private $source;
    private $macros = [];
  ...
  ";
      ...
      <select name=\"";
        ...
        ";
            // line 53
            if (is_iterable(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["form"] ?? null), "vars", [], "any", false, false, false, 53), "locales", [], "any", false, false, false, 53))) {
                // line 54
                echo "          ";
                $context['_parent'] = $context;
