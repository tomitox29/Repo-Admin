...
class __TwigTemplate_1a17f5af173830f7abf3614f792951b8 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["action"]) {
                // line 33
                echo "      ";
                if (twig_get_attribute($this->env, $this->source, $context["action"], "isApplicable", [($context["record"] ?? null)], "method", false, false, false, 33)) {
                    // line 34
                    echo "        ";
                    if (((($__internal_compile_0 = twig_get_attribute($this->env, $this->source, $context["action"], "options", [], "any", false, false, false, 34)) && is_array($__internal_compile_0) || $__internal_compile_0 instanceof ArrayAccess ? ($__internal_compile_0["use_inline_display"] ?? null) : null) == true)) {
                        // line 35
                        echo "            ";
                        $context["inlineActions"] = twig_array_merge(($context["inlineActions"] ?? null), [$context["action"]]);
                        // line 36
                        echo "          ";
                    } else {
                        // line 37
                        echo "            ";
                        $context["regularActions"] = twig_array_merge(($context["regularActions"] ?? null), [$context["action"]]);
                        // line 38
                        echo "        ";
                    }
                    // line 39
