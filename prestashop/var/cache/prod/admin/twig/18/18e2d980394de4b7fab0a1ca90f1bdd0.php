...
class __TwigTemplate_d65e8b04abcc58bdb439729c4e7dd0a2 extends Template
{
    private $source;
    private $macros = [];
...
($context["label"] ?? null) === false)) {
    ...
    public function block_form_label_class($context, array $blocks = [])
    {
        ...
        if (((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["form"] ?? null), "vars", [], "any", false, true, false, 63), "attr", [], "any", false, true, false, 63), "disabled", [], "any", true, true, false, 63) && twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["form"] ?? null), "vars", [], "any", false, false, false, 63), "attr", [], "any", false, false, false, 63), "disabled", [], "any", false, false, false, 63)) || (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["form"] ?? null), "vars", [], "any", false, true, false, 63), "disabled", [], "any", true, true, false, 63) && twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["form"] ?? null), "vars", [], "any", false, false, false, 63), "disabled", [], "any", false, false, false, 63)))) {
            echo " disabled";
        }
    }
    ...
    <div class=\"";
      ...
      ";
        // line 97
        if ((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["form"] ?? null), "parent", [], "any", false, true, false, 97), twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["form"] ?? null), "vars", [], "any", false, false, false, 97), "name", [], "any", false, false, false, 97), [], "any", true, true, false, 97) && (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["form"] ?? null), "parent", [], "any", false, false, false, 97), twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["form"] ?? null), "vars", [], "any", false, false, false, 97), "name", [], "any", false, false, false, 97), [], "any", false, false, false, 97), "vars", [], "any", false, false, false, 97), "multistore_dropdown", [], "any", false, false, false, 97) != false))) {
            // line 98
            echo "        ";
            echo twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["form"] ?? null), "parent", [], "any", false, false, false, 98), twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["form"] ?? null), "vars", [], "any", false, false, false, 98), "name", [], "any", false, false, false, 98), [], "any", false, false, false, 98), "vars", [], "any", false, false, false, 98), "multistore_dropdown", [], "any", false, false, false, 98);
            echo "
      ";
        }
        // line 101
  ...
  ";
    ...
    public function block_form_row_class($context, array $blocks = [])
    {
        ...
        // line 115
        echo "form-group row";
        if (twig_get_attribute($this->env, $this->source, ($context["row_attr"] ?? null), "class", [], "any", true, true, false, 115)) {
            echo " ";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["row_attr"] ?? null), "class", [], "any", false, false, false, 115), "html", null, true);
        }
    }
    ...
    {
        return array (  300 => 115,  296 => 114,  292 => 111,  288 => 110,  282 => 106,  280 => 105,  277 => 104,  275 => 69,  271 => 102,  269 => 101,  263 => 98,  261 => 97,  258 => 96,  256 => 95,  254 => 94,  250 => 93,  248 => 92,  241 => 91,  235 => 89,  233 => 88,  230 => 87,  225 => 85,  220 => 84,  217 => 83,  215 => 82,  204 => 81,  201 => 80,  198 => 79,  195 => 78,  192 => 77,  189 => 76,  187 => 75,  184 => 74,  178 => 72,  175 => 71,  173 => 70,  171 => 69,  167 => 68,  160 => 63,  156 => 62,  152 => 50,  149 => 59,  146 => 57,  143 => 56,  140 => 55,  138 => 54,  136 => 53,  131 => 52,  128 => 51,  126 => 50,  122 => 49,  118 => 44,  116 => 43,  112 => 42,  108 => 114,  105 => 113,  103 => 110,  100 => 109,  98 => 68,  95 => 67,  92 => 65,  90 => 62,  87 => 61,  85 => 49,  82 => 48,  79 => 46,  77 => 42,  74 => 41,  71 => 39,  68 => 36,  65 => 25,  37 => 38,  30 => 37,);
    }
