...
class __TwigTemplate_e3be8e65032379987720eb15018b294f extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"col-lg-10\">
      <div id=\"module-short-list-update\" class=\"module-short-list\">
        ...
        ";
        // line 37
        if (((twig_length_filter($this->env, ($context["modules"] ?? null)) > 1) && (($context["level"] ?? null) >= twig_constant("PrestaShop\\PrestaShop\\Core\\Security\\Permission::LEVEL_UPDATE")))) {
            // line 38
            ...
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Update all", [], "Admin.Modules.Feature"), "html", null, true);
            echo "</a>
        ";
        }
        // line 40
