...
class __TwigTemplate_37620ac608cdd1e7f0403dec68b5f60f extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    ";
            ...
            $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "request", [], "any", false, false, false, 30), "attributes", [], "any", false, false, false, 30), "get", ["_route_params"], "method", false, false, false, 30));
