...
class __TwigTemplate_8d80d4a9afaa22966bc8855f6fe5a97e extends Template
{
    private $source;
    private $macros = [];
...
($context["app"] ?? null), "request", [], "any", false, false, false, 28), "attributes", [], "any", false, false, false, 28), "get", ["_legacy_controller"], "method", false, false, false, 28), "controller" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source,         // line 29
...
($context["app"] ?? null), "request", [], "any", false, false, false, 77), "attributes", [], "any", false, false, false, 77), "get", ["_legacy_controller"], "method", false, false, false, 77), "controller" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source,         // line 78
