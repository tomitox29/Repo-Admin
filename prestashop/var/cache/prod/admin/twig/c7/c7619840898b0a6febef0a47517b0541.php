...
class __TwigTemplate_6124f1f85895ca84a4ca8585f047d7bd extends Template
{
    private $source;
    private $macros = [];
...
";
        // line 26
        if ((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "request", [], "any", false, false, false, 26), "query", [], "any", false, false, false, 26), "has", ["id_category"], "method", false, false, false, 26) &&  !twig_get_attribute($this->env, $this->source, ($context["currentCategoryView"] ?? null), "is_home_category", [], "any", false, false, false, 26))) {
            // line 27
            echo "  ";
