...
class __TwigTemplate_326f110c964912e3402d5d76f5c70e34 extends Template
{
    private $source;
    private $macros = [];
  ...
  ";
    ...
    public function block_multishop_header_right($context, array $blocks = [])
    {
        ...
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["link"] ?? null), "getBaseLink", [twig_get_attribute($this->env, $this->source, ($context["currentContext"] ?? null), "id", [], "any", false, false, false, 55)], "method", false, false, false, 55), "html", null, true);
    ...
    public function block_shop_item($context, array $blocks = [])
    {
        ...
        if (twig_get_attribute($this->env, $this->source, ($context["shop"] ?? null), "hasMainUrl", [], "method", false, false, false, 107)) {
            ...
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["link"] ?? null), "getBaseLink", [twig_get_attribute($this->env, $this->source, ($context["shop"] ?? null), "id", [], "any", false, false, false, 108)], "method", false, false, false, 108), "html", null, true);
