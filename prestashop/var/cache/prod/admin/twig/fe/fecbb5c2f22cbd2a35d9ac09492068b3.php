...
class __TwigTemplate_6c8326858f890466b636ca1b09dfb28b extends Template
{
    private $source;
    private $macros = [];
...
";
        // line 26
        if (((twig_test_empty(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["column"] ?? null), "options", [], "any", false, false, false, 26), "disabled_field", [], "any", false, false, false, 26)) ||  !(($__internal_compile_0 = ($context["record"] ?? null)) && is_array($__internal_compile_0) || $__internal_compile_0 instanceof ArrayAccess ? ($__internal_compile_0[twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["column"] ?? null), "options", [], "any", false, false, false, 26), "disabled_field", [], "any", false, false, false, 26)] ?? null) : null)) && ( !twig_get_attribute($this->env, $this->source, ($context["record"] ?? null), "disableBulkCheckbox", [], "any", true, true, false, 26) ||  !twig_get_attribute($this->env, $this->source, ($context["record"] ?? null), "disableBulkCheckbox", [], "any", false, false, false, 26)))) {
            // line 27
