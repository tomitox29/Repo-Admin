...
class getHookRepositoryService extends AdminKernelProdContainer
{
    ...
    {
        return $container->services['hook_repository'] = new \PrestaShop\PrestaShop\Core\Module\HookRepository(($container->services['prestashop.adapter.legacy.hook'] ??= new \PrestaShop\PrestaShop\Adapter\Hook\HookInformationProvider()), ($container->services['PrestaShop\\PrestaShop\\Adapter\\LegacyContext'] ?? self::getLegacyContextService($container))->getContext()->shop, ($container->services['prestashop.adapter.legacy_db'] ?? $container->load('getPrestashop_Adapter_LegacyDbService')));
    }
}
